            ...
            <main className="sticky">
                    ...
                    <div className="backdrop-blur-lg bg-white bg-opacity-5 p-5 lg:px-8 px-4 rounded-2xl">
                        <div className='w-full m-auto flex justify-between items-center'>
                            ...
                            <div className='flex gap-x-2 items-center cursor-pointer'>
                                <img className="h-10 w-12 p-1 hover:animate-pulse" src="logo2.png" />
                            </div>
                ...
                <div className="w-[90%] h-full text-white comfort mx-5 sm:mx-10 md:mx-20 my-32">
                    ...
                    <div className="flex gap-10 my-10 justify-center flex-wrap    items-center">
                        <img className="w-24 h-24 sm:w-32 sm:h-32 md:w-56 md:h-56 rounded-xl hover:scale-[1.1] transition-all ease-in-out" src="./14.png" />
                        <img className="w-24 h-24 sm:w-32 sm:h-32 md:w-56 md:h-56 hover:scale-[1.1] transition-all ease-in-out p-5" src="./12.png" />
                        <img className="w-24 h-24 sm:w-32 sm:h-32 md:w-56 md:h-56 hover:scale-[1.1] transition-all ease-in-out p-6  md:p-14" src="./13.png" />
                    </div>
                ...
                <div className="w-[90%] h-full text-white comfort mx-5 sm:mx-10 md:mx-20 my-32">
                    ...
                    <a href="https://www.linkedin.com/in/rahulsinghal01/" target={"_blank"}>
                        <div className="my-10 flex-row text-center flex flex-wrap md:justify-start justify-center items-center gap-6">
                            ...
                            <h1 className="monu mt-2 hover:text-blue-500 cursor-pointer">Rahul Singhal</h1>
                        ...
                        <a target={"_blank"} href={"https://linktr.ee/surajxd"}>
                            <div className="my-10 text-center flex justify-center md:justify-start flex-wrap items-center flex-row gap-8">
                                <div class="card rounded-xl overflow-hidden hover:scale-[1.1] transition-all ease-in-out">
                                ...
                                {/* <div className="w-10 h-[1px] bg-white mt-4"></div> */}
                                <h1 className="monu mt-2 hover:text-blue-500 cursor-pointer">Suraj Gaud</h1>
                                <h1 className=" font-extrabold">Head</h1>
                    ...
                    <div className="flex flex-col justify-start text-[1.3rem]">
                        ...
                        <Link target={"_blank"} href={"https://www.linkedin.com/in/shubhanshu-saxena-902511230"}>
                            <h1 className="monu mt-2  cursor-pointer">Subhanshu Saxena</h1>
                        </Link>
                    </div>

                </div>
                <div className="md:hidden block w-[90%] h-full text-white comfort mx-10 md:mx-20 my-32">
                    <div className="">
                        <div className="w-20 h-[1px] bg-white my-2"></div>
